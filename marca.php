...
<?php
	...
	require_once("Recursos/class/class.marca.php");
	$cn = conectar();
	$m = new marca($cn);
	//echo $v->get_list();
...
/*			echo "<pre>";
		...
		//	echo $dato;exit;
	    	if($op == "det"){
				...
				echo $m->get_form_marca($id);
			}elseif($op == "new"){
				echo $m->get_form_marca();
			}elseif($op == "del"){
				echo $m->delete_marca($id);; // BORRAR TODOS LOS REGISTROS DE LA BASE DE DATOS
			}	
